...
@section('content')
    <div class="card mt-5">
        ...
        <div class="card-body">
            ...
            @endif
            <form action="{{ route('permohonan-penempatan.update', $pengajuanPenempatan->id) }}"
                ...
                <div class="form-group">
                    ...
                    <input class="form-input" id="tahun_ajaran" name="tahun_ajaran" required type="text"
                        value="{{ old('tahun_ajaran', $pengajuanPenempatan->tahun_ajaran) }}">
                    @error('tahun_ajaran')
                ...
                <div class="form-group">
                    ...
                    <select class="mt-1 block w-full rounded border border-gray-300 p-2" id="perusahaan_id"
                        ...
                        @foreach ($perusahaan as $item)
                            <option
                                {{ old('perusahaan_id', $pengajuanPenempatan->perusahaan_id) == $item->id ? 'selected' : '' }}
                                value="{{ $item->id }}">
                ...
                <div class="form-group">
                    ...
                    <select class="mt-1 block w-full rounded border border-gray-300 p-2" id="guru_id" name="guru_id">
                        ...
                        @foreach ($gurus as $item)
                            <option {{ old('guru_id', $pengajuanPenempatan->guru_id) == $item->id ? 'selected' : '' }}
                                value="{{ $item->id }}">
                ...
                <div class="form-group">
                    ...
                    <select class="mt-1 block w-full rounded border border-gray-300 p-2" id="instruktur_id"
                        ...
                        @foreach ($instrukturs as $item)
                            <option
                                {{ old('instruktur_id', $pengajuanPenempatan->instruktur_id) == $item->id ? 'selected' : '' }}
                                value="{{ $item->id }}">
                                {{ $item->nama ?? 'N/A' }}</option>
                        @endforeach
                    </select>
                ...
                <div class="mb-4">
                    ...
                    <input
                        ...
                        id="tanggal_mulai" name="tanggal_mulai" required type="date"
                        value="{{ old('tanggal_mulai', $pengajuanPenempatan->tanggal_mulai) }}">
                    @error('tanggal_mulai')
                ...
                <div class="mb-4">
                    ...
                    <input
                        ...
                        value="{{ old('tanggal_selesai', $pengajuanPenempatan->tanggal_selesai) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-input" id="file_pendukung" name="file_pendukung" type="file">
                    @if ($pengajuanPenempatan->file_pendukung)
                        <p class="current-file">File saat ini: <a class="text-blue-500 hover:underline"
                                href="{{ asset('storage/files/' . $pengajuanPenempatan->file_pendukung) }}"
                                target="_blank">{{ $pengajuanPenempatan->file_pendukung }}</a></p>
                    @endif
