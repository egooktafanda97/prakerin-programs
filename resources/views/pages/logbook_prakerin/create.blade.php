...
@section('content')
    <div class="card mt-5">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('logbook-prakerin.store') }}" class="px-5 pt-5 pb-2" method="POST">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            id="tanggal" name="tanggal" required type="date" value="{{ old('tanggal') }}" />
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                            id="aktivitas" name="aktivitas" placeholder="Deskripsikan aktivitas prakerin hari ini..." required rows="4">{{ old('aktivitas') }}</textarea>
                    </div>
