        ...
        <div class="card-header mb-0 pl-5 pr-5 pt-5 pb-0">
            <div class="flex justify-between">
                ...
                <a class="text-white btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20"
                    href="{{ route('perusahaan.create') }}">Tambah PT</a>
            </div>
        </div>
        <div class="card-body">
                ...
                .map((item) => [
                    ...
                    gridjs.html(
                        `<div class="flex gap-2">
                            <a href="/perusahaan/${item.id}/edit" class="flex items-center justify-center size-[37.5px] p-0 text-white btn bg-green-500 border-green-500 hover:text-white hover:bg-green-600 hover:border-green-600 focus:text-white focus:bg-green-600 focus:border-green-600 focus:ring focus:ring-green-100 active:text-white active:bg-green-600 active:border-green-600 active:ring active:ring-green-100 dark:ring-green-400/20">
                                <i class="fa fa-edit"></i>
                                </a>
                            <form action="/perusahaan/${item.id}" method="POST" class="inline">
                                @csrf
                                @method('DELETE')
