...
<body
    ...
    <div class="group-data-[sidebar-size=sm]:min-h-sm group-data-[sidebar-size=sm]:relative">
        ...
        <div
            ...
            <div
                ...
                <a class="group-data-[sidebar=dark]:hidden group-data-[sidebar=brand]:hidden group-data-[sidebar=modern]:hidden"
                    href="index.html">
                    <span class="hidden group-data-[sidebar-size=sm]:block">
                        {{-- <img alt="" class="h-6 mx-auto" src="{{ asset('logo/logo.png') }}"> --}}
                    </span>
                    <span class="group-data-[sidebar-size=sm]:hidden">
                        {{-- <img alt="" class="h-6 mx-auto" src="{{ asset('logo/logo.png') }}"> --}}
                    </span>
                </a>
                <a class="hidden group-data-[sidebar=dark]:block group-data-[sidebar=brand]:block group-data-[sidebar=modern]:block"
                    href="index.html">
                    <span class="hidden group-data-[sidebar-size=sm]:block">
                        {{-- <img alt="" class="h-6 mx-auto" src="{{ asset('logo/logo.png') }}"> --}}
                    </span>
        ...
        <!-- Left Sidebar End -->
        <div class="absolute inset-0 z-[1002] bg-slate-500/30 hidden" id="sidebar-overlay"></div>
    ...
    <div class="fixed items-center hidden bottom-6 right-12 h-header group-data-[navbar=hidden]:flex">
        <button
            ...
            data-drawer-target="customizerButton" type="button">
            <i class="inline-block w-5 h-5" data-lucide="settings"></i>
        </button>
    </div>

    <div class="fixed inset-y-0 flex flex-col w-full transition-transform duration-300 ease-in-out transform bg-white shadow ltr:right-0 rtl:left-0 md:w-96 z-drawer show dark:bg-zink-600"
        drawer-end="" id="customizerButton">
        <div class="flex justify-between p-4 border-b border-slate-200 dark:border-zink-500">
            ...
            <div class="shrink-0">
                <button
                    ...
                    data-drawer-close="customizerButton"><i class="w-4 h-4" data-lucide="x"></i></button>
            </div>
        </div>
        <div class="h-full p-6 overflow-y-auto">
                ...
                <div class="grid grid-cols-1 mb-5 gap-7 sm:grid-cols-2">
                    <div class="relative">
                        <input checked=""
                            ...
                            id="layout-one" name="dataLayout" type="radio" value="vertical">
                        <label
                    ...
                    <div class="relative">
                        <input
                            class="absolute w-4 h-4 border rounded-full appearance-none cursor-pointer ltr:right-2 rtl:left-2 top-2 vertical-menu-btn bg-slate-100 border-slate-300 checked:bg-custom-500 checked:border-custom-500 dark:bg-zink-400 dark:border-zink-500"
                            id="layout-two" name="dataLayout" type="radio" value="horizontal">
                        <label
                            class="block w-full h-24 p-0 overflow-hidden border rounded-lg cursor-pointer border-slate-200 dark:border-zink-500"
                            for="layout-two">
                    ...
                    <div class="flex items-center">
                        <div class="relative inline-block w-10 mr-2 align-middle transition duration-200 ease-in">
                            <input
                                ...
                                id="customDefaultSwitch" name="customDefaultSwitch" type="checkbox" value="dark">
                            <label
                                ...
                                for="customDefaultSwitch"></label>
                        </div>
                        <label class="inline-block text-base font-medium" for="customDefaultSwitch">Semi Dark
            ...
            <div class="mt-6">
                ...
                <div class="grid grid-cols-1 mb-5 gap-7 sm:grid-cols-2">
                    <div class="relative">
                        <input
                            class="absolute w-4 h-4 border rounded-full appearance-none cursor-pointer ltr:right-2 rtl:left-2 top-2 vertical-menu-btn bg-slate-100 border-slate-300 checked:bg-custom-500 checked:border-custom-500 dark:bg-zink-400 dark:border-zink-500"
                            id="layoutSkitOne" name="dataLayoutSkin" type="radio" value="default">
                        <label
                    ...
                    <div class="relative">
                        <input checked=""
                            class="absolute w-4 h-4 border rounded-full appearance-none cursor-pointer ltr:right-2 rtl:left-2 top-2 vertical-menu-btn bg-slate-100 border-slate-300 checked:bg-custom-500 checked:border-custom-500 dark:bg-zink-400 dark:border-zink-500"
                            id="layoutSkitTwo" name="dataLayoutSkin" type="radio" value="bordered">
                        <label
                            class="block w-full h-24 p-0 overflow-hidden border rounded-lg cursor-pointer border-slate-200 dark:border-zink-500"
                            for="layoutSkitTwo">
                            <span class="flex h-full gap-0">
            ...
            <div class="mt-6">
                ...
                <div class="flex gap-3">
                    <button
                        ...
                        id="dataModeOne" name="dataMode" type="button" value="light">Light Mode</button>
                    <button
                        class="transition-all duration-200 ease-linear bg-white border-dashed text-slate-500 btn border-slate-200 hover:text-slate-500 hover:bg-slate-50 hover:border-slate-200 [&.active]:text-custom-500 [&.active]:bg-custom-50 [&.active]:border-custom-200 dark:bg-zink-600 dark:text-zink-200 dark:border-zink-400 dark:hover:bg-zink-600 dark:hover:text-zink-100 dark:hover:border-zink-400 dark:[&.active]:bg-custom-500/10 dark:[&.active]:border-custom-500/30 dark:[&.active]:text-custom-500"
                        id="dataModeTwo" name="dataMode" type="button" value="dark">Dark Mode</button>
                </div>
            </div>
            ...
            <div class="mt-6">
                ...
                <div class="flex flex-wrap gap-3">
                    <button
                        class="transition-all duration-200 ease-linear bg-white border-dashed text-slate-500 btn border-slate-200 hover:text-slate-500 hover:bg-slate-50 hover:border-slate-200 [&.active]:text-custom-500 [&.active]:bg-custom-50 [&.active]:border-custom-200 dark:bg-zink-600 dark:text-zink-200 dark:border-zink-400 dark:hover:bg-zink-600 dark:hover:text-zink-100 dark:hover:border-zink-400 dark:[&.active]:bg-custom-500/10 dark:[&.active]:border-custom-500/30 dark:[&.active]:text-custom-500 active"
                        id="diractionOne" name="dir" type="button" value="ltr">LTR Mode</button>
                    <button
                        class="transition-all duration-200 ease-linear bg-white border-dashed text-slate-500 btn border-slate-200 hover:text-slate-500 hover:bg-slate-50 hover:border-slate-200 [&.active]:text-custom-500 [&.active]:bg-custom-50 [&.active]:border-custom-200 dark:bg-zink-600 dark:text-zink-200 dark:border-zink-400 dark:hover:bg-zink-600 dark:hover:text-zink-100 dark:hover:border-zink-400 dark:[&.active]:bg-custom-500/10 dark:[&.active]:border-custom-500/30 dark:[&.active]:text-custom-500"
                        id="diractionTwo" name="dir" type="button" value="rtl">RTL Mode</button>
                </div>
            </div>
            ...
            <div class="mt-6">
                ...
                <div class="flex gap-3">
                    <button
                        class="transition-all duration-200 ease-linear bg-white border-dashed text-slate-500 btn border-slate-200 hover:text-slate-500 hover:bg-slate-50 hover:border-slate-200 [&.active]:text-custom-500 [&.active]:bg-custom-50 [&.active]:border-custom-200 dark:bg-zink-600 dark:text-zink-200 dark:border-zink-400 dark:hover:bg-zink-600 dark:hover:text-zink-100 dark:hover:border-zink-400 dark:[&.active]:bg-custom-500/10 dark:[&.active]:border-custom-500/30 dark:[&.active]:text-custom-500 active"
                        id="datawidthOne" name="datawidth" type="button" value="fluid">Fluid</button>
                    <button
                        class="transition-all duration-200 ease-linear bg-white border-dashed text-slate-500 btn border-slate-200 hover:text-slate-500 hover:bg-slate-50 hover:border-slate-200 [&.active]:text-custom-500 [&.active]:bg-custom-50 [&.active]:border-custom-200 dark:bg-zink-600 dark:text-zink-200 dark:border-zink-400 dark:hover:bg-zink-600 dark:hover:text-zink-100 dark:hover:border-zink-400 dark:[&.active]:bg-custom-500/10 dark:[&.active]:border-custom-500/30 dark:[&.active]:text-custom-500"
                        id="datawidthTwo" name="datawidth" type="button" value="boxed">Boxed</button>
                </div>
            </div>
            ...
            <div class="mt-6" id="sidebar-size">
                ...
                <div class="flex flex-wrap gap-3">
                    <button
                        class="transition-all duration-200 ease-linear bg-white border-dashed text-slate-500 btn border-slate-200 hover:text-slate-500 hover:bg-slate-50 hover:border-slate-200 [&.active]:text-custom-500 [&.active]:bg-custom-50 [&.active]:border-custom-200 dark:bg-zink-600 dark:text-zink-200 dark:border-zink-400 dark:hover:bg-zink-600 dark:hover:text-zink-100 dark:hover:border-zink-400 dark:[&.active]:bg-custom-500/10 dark:[&.active]:border-custom-500/30 dark:[&.active]:text-custom-500 active"
                        id="sidebarSizeOne" name="sidebarSize" type="button" value="lg">Default</button>
                    <button
                        class="transition-all duration-200 ease-linear bg-white border-dashed text-slate-500 btn border-slate-200 hover:text-slate-500 hover:bg-slate-50 hover:border-slate-200 [&.active]:text-custom-500 [&.active]:bg-custom-50 [&.active]:border-custom-200 dark:bg-zink-600 dark:text-zink-200 dark:border-zink-400 dark:hover:bg-zink-600 dark:hover:text-zink-100 dark:hover:border-zink-400 dark:[&.active]:bg-custom-500/10 dark:[&.active]:border-custom-500/30 dark:[&.active]:text-custom-500"
                        id="sidebarSizeTwo" name="sidebarSize" type="button" value="md">Compact</button>
                    <button
                        class="transition-all duration-200 ease-linear bg-white border-dashed text-slate-500 btn border-slate-200 hover:text-slate-500 hover:bg-slate-50 hover:border-slate-200 [&.active]:text-custom-500 [&.active]:bg-custom-50 [&.active]:border-custom-200 dark:bg-zink-600 dark:text-zink-200 dark:border-zink-400 dark:hover:bg-zink-600 dark:hover:text-zink-100 dark:hover:border-zink-400 dark:[&.active]:bg-custom-500/10 dark:[&.active]:border-custom-500/30 dark:[&.active]:text-custom-500"
                        id="sidebarSizeThree" name="sidebarSize" type="button" value="sm">Small
                        (Icon)</button>
                </div>
            </div>
            ...
            <div class="mt-6" id="navigation-type">
                ...
                <div class="flex flex-wrap gap-3">
                    <button
                        class="transition-all duration-200 ease-linear bg-white border-dashed text-slate-500 btn border-slate-200 hover:text-slate-500 hover:bg-slate-50 hover:border-slate-200 [&.active]:text-custom-500 [&.active]:bg-custom-50 [&.active]:border-custom-200 dark:bg-zink-600 dark:text-zink-200 dark:border-zink-400 dark:hover:bg-zink-600 dark:hover:text-zink-100 dark:hover:border-zink-400 dark:[&.active]:bg-custom-500/10 dark:[&.active]:border-custom-500/30 dark:[&.active]:text-custom-500 active"
                        id="navbarTwo" name="navbar" type="button" value="sticky">Sticky</button>
                    <button
                        class="transition-all duration-200 ease-linear bg-white border-dashed text-slate-500 btn border-slate-200 hover:text-slate-500 hover:bg-slate-50 hover:border-slate-200 [&.active]:text-custom-500 [&.active]:bg-custom-50 [&.active]:border-custom-200 dark:bg-zink-600 dark:text-zink-200 dark:border-zink-400 dark:hover:bg-zink-600 dark:hover:text-zink-100 dark:hover:border-zink-400 dark:[&.active]:bg-custom-500/10 dark:[&.active]:border-custom-500/30 dark:[&.active]:text-custom-500"
                        id="navbarOne" name="navbar" type="button" value="scroll">Scroll</button>
                    <button
                        class="transition-all duration-200 ease-linear bg-white border-dashed text-slate-500 btn border-slate-200 hover:text-slate-500 hover:bg-slate-50 hover:border-slate-200 [&.active]:text-custom-500 [&.active]:bg-custom-50 [&.active]:border-custom-200 dark:bg-zink-600 dark:text-zink-200 dark:border-zink-400 dark:hover:bg-zink-600 dark:hover:text-zink-100 dark:hover:border-zink-400 dark:[&.active]:bg-custom-500/10 dark:[&.active]:border-custom-500/30 dark:[&.active]:text-custom-500"
                        id="navbarThree" name="navbar" type="button" value="bordered">Bordered</button>
                    <button
                        class="transition-all duration-200 ease-linear bg-white border-dashed text-slate-500 btn border-slate-200 hover:text-slate-500 hover:bg-slate-50 hover:border-slate-200 [&.active]:text-custom-500 [&.active]:bg-custom-50 [&.active]:border-custom-200 dark:bg-zink-600 dark:text-zink-200 dark:border-zink-400 dark:hover:bg-zink-600 dark:hover:text-zink-100 dark:hover:border-zink-400 dark:[&.active]:bg-custom-500/10 dark:[&.active]:border-custom-500/30 dark:[&.active]:text-custom-500"
                        id="navbarFour" name="navbar" type="button" value="hidden">Hidden</button>
                </div>
            </div>
            ...
            <div class="mt-6" id="sidebar-color">
                ...
                <div class="flex flex-wrap gap-3">
                    <button
                        ...
                        id="sidebarColorOne" name="sidebarColor" type="button" value="light"><i
                    ...
                    <button
                        ...
                        id="sidebarColorTwo" name="sidebarColor" type="button" value="dark"><i
                    ...
                    <button
                        ...
                        id="sidebarColorThree" name="sidebarColor" type="button" value="brand"><i
                            class="w-5 h-5 hidden group-[.active]:inline-block text-white"
                            data-lucide="check"></i></button>
                    <button
                        ...
                        id="sidebarColorFour" name="sidebarColor" type="button" value="modern"><i
                            class="w-5 h-5 hidden group-[.active]:inline-block text-white"
                            data-lucide="check"></i></button>
                </div>
            </div>
            ...
            <div class="mt-6">
                ...
                <div class="flex flex-wrap gap-3">
                    <button
                        class="flex items-center justify-center w-10 h-10 bg-white border rounded-md border-slate-200 group active"
                        id="topbarColorOne" name="topbarColor" type="button" value="light"><i
                            class="w-5 h-5 hidden group-[.active]:inline-block text-slate-600"
                            data-lucide="check"></i></button>
                    <button
                        class="flex items-center justify-center w-10 h-10 border rounded-md border-zink-900 bg-zink-900 group"
                        id="topbarColorTwo" name="topbarColor" type="button" value="dark"><i
                            class="w-5 h-5 hidden group-[.active]:inline-block text-white"
                            data-lucide="check"></i></button>
                    <button
                        class="flex items-center justify-center w-10 h-10 border rounded-md border-custom-800 bg-custom-800 group"
                        id="topbarColorThree" name="topbarColor" type="button" value="brand"><i
                            class="w-5 h-5 hidden group-[.active]:inline-block text-white"
                            data-lucide="check"></i></button>
                </div>
            </div>
        ...
        <div class="flex items-center justify-between gap-3 p-4 border-t border-slate-200 dark:border-zink-500">
            <button
                ...
                id="reset-layout" type="button">Reset</button>
            <a class="w-full text-white transition-all duration-200 ease-linear bg-red-500 border-red-500 btn hover:text-white hover:bg-red-600 hover:border-red-600 focus:text-white focus:bg-red-600 focus:border-red-600 focus:ring focus:ring-red-100 active:text-white active:bg-red-600 active:border-red-600 active:ring active:ring-red-100"
                href="#!">Buy Now</a>
        </div>
    </div>
